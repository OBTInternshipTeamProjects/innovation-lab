...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo BASE_URL; ?>/assets/css/navedit.css">
...
<header class="main_h">
	...
	<div id="programs">
		...
		<h2>What we offer at the Innovation Lab:</h2></div>
		<div class="accordion">
	...
	<div id="location">
		...
		<p>Innovation Lab at 87 35th Street, 2nd Fl Brooklyn, NY 11232</p>
	  ...
	  <!----------------------------------------------------->
        <div id="first" class="line-inputs">
          ...
          <div id="second" class="line-inputs">
            ...
            <br>
<input id="phone-input" name="phone_number" type="tel" value="" aria-label="Please enter your phone number" placeholder="ex. 1(111)-111-1111">
        </div>
	<!----------------------------------------------------->
